...
<body>
    <main>
        ...
        <div id="test" class="u-clearfix u-sheet u-sheet-1">
            ...
            <p style="justify-content: center;text-align: justify;"> It has come to our attention that your claim, dated {{ strtoupper(\Carbon\Carbon::parse($policyClaim->created_at)->format('jS F Y')) }}, has been forfeited by Ezcare Warranty due to the <b>unavailability of a repair quotation</b> from the workshop within 14 days of submission.&nbsp;</p>
            <p style="justify-content: center;text-align: justify;"> Our claims department made multiple attempts to contact the workshop to obtain the required repair estimate. Despite our efforts, we did not receive a response or quotation from the workshop within the designated timeframe.&nbsp;</p>
            <p style="justify-content: center;text-align: justify;">As outlined in the terms and conditions of your policy, providing Ezcare Warranty with a repair quotation from the workshop is essential for processing the claim in a timely and efficient manner. Unfortunately, no repair quotation was received from your side for over 30 days.&nbsp;</p>
            <p style="justify-content: center;text-align: justify;">If you have any further queries or require any assistance regarding this matter, please do not hesitate to contact us at <b>1-300-88-8287</b>&nbsp;</p>
