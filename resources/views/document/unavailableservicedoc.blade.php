...
<body>
    <main>
        ...
        <div id="test" class="u-clearfix u-sheet u-sheet-1">
            ...
            <p style="justify-content: center;text-align: justify;"> Upon cross-verifying the service records, it has been revealed that the vehicle has not undergone any documented service in accordance with the service maintenance intervals required by Ezcare Warranty, indicating a <b>LACK OF SERVICING</b>.&nbsp;</p>
            <p style="justify-content: center;text-align: justify;"> The claims department has carefully reviewed the service documentation, which confirms that the necessary maintenance services were not performed as stipulated by Ezcare Warranty’s policy terms and conditions.&nbsp;</p>
