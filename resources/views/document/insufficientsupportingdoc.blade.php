...
<body>
    <main>
        ...
        <div id="test" class="u-clearfix u-sheet u-sheet-1">
            ...
            <p style="justify-content: center;text-align: justify;"> Upon cross-verifying the service records, it has been revealed that the <b>insufficiency of supporting documents</b>, specifically the vehicle's service maintenance invoices.&nbsp;</p>
            <p style="justify-content: center;text-align: justify;"> As outlined in our warranty policy, we require supporting documentation, such as service maintenance receipts from the workshop, to ensure that the vehicle has been properly maintained in accordance with the scheduled service intervals as stipulated by Ezcare Warranty.&nbsp;</p>
            <p style="justify-content: center;text-align: justify;"> Due to the insufficiency of the submitted documentation, we are unable to authorize your claim as it lacks the necessary evidence for approval.&nbsp;</p>
