...
export default function EzGetQuotation() {
                ...
                <Container size='xl' pos='relative'>
                    ...
                    >
                        <Flex align='start' direction='column' mt={{ base: 20, sm: 20, xl: 30 }} ff='Lato' >
                            <Text lh='normal' c='#333' fz={{ base: 35, sm: 35, lg: 40 }} fw={900} tt='uppercase' style={{ lineHeight: 2 }} mb={30}>{t('gq_1')}</Text>
                            <Text lh='normal' c='#333' fz={{ base: 22, sm: 22, lg: 22 }} fw={500} tt='uppercase' style={{ lineHeight: 2 }}>{t('gq_2')}</Text>
                            <Text lh='normal' c='#862E9C' fz={{ base: 35, sm: 35, lg: 40 }} fw={900} mb={30} tt='uppercase' style={{ lineHeight: 2 }} mt={10}>Ezcare Warranty</Text>

                            <Text fz={{ base: 22, sm: 22, lg: 22 }} fw={300} ff='Roboto' style={{ wordBreak: 'keep-all' }} ta='justify' pr={20}>
                                {t('gq_3')}
                            </Text>
                            <Text fz={{ base: 22, sm: 22, lg: 22 }} mb={40} ff='Roboto' style={{ wordBreak: 'keep-all' }} ta='justify' pr={20}>{t('gq_4')}</Text>
                            <Image src={'/images/features/staffsupport.jpeg'} w={{ base: '100%', sm: '100%', md: '100%', xl: '100%' }} h={350} mb={{ base: 20, sm: 20, xl: 0 }} radius='lg' />
                        </Flex>
                            ...
                            <Card shadow="xl" radius="xl" p="xl" mt={20} withBorder maw={600}>
                                ...
                                <Card.Section pt={0}>
                                    ...
                                    <Box p='md' ta='center'>
                                        ...
                                        <Text mt={20} fz={18}>{t('gq_6')} <a href="tel:6281110020356">62 81110020356</a> {t('gq_7')}</Text>
