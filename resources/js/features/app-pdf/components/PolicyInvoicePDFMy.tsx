...
export default function PolicyInvoicePDFMy({ data, title }: { data: any, title: any }) {
                ...
                <View style={styles.column}>
                    ...
                    <View style={styles.row}>
                        ...
                        <View style={{ ...styles.section, textAlign: 'right' }}>
                            ...
                            <Text style={{ ...styles.pSlim, textTransform: 'uppercase' }}>{data.policy.technical_staff_name}</Text>
                            <Text style={styles.h3Slim}>MARKETING OFFICER:</Text>
                            <Text style={{ ...styles.pSlim, textTransform: 'uppercase' }}>{data.policy.mo_name}</Text>
                    ...
                    <View style={styles.row}>
                        <View style={styles.table}>
                            <View style={styles.tableRow}>
                                ...
                                <View style={{ ...styles.tableCol4, ...styles.tableCol, ...styles.tableColFlexBottom }}><Text>UNIT PRICE (RM)</Text></View>
                    ...
                    <View style={styles.row}>
                        ...
                        <View style={{ marginTop: 20 }}>
                            ...
                            <View style={styles.row}>
                                ...
                                <Text style={{ ...styles.p, width: 200 }}>562384525692</Text>
                            </View>
                            <View style={styles.row}>
                    ...
                    <View style={{ marginTop: 10 }}>
                        <Text style={{ ...styles.p, fontSize: 7 }}>Please email the bank slip at info@ezcare-warranty.com once payment has been made.</Text>
                    ...
                    <View style={styles.row}>
                        <View style={styles.section}>
                            <Text style={{ ...styles.h3, fontSize: 7 }}>EZCARE WARRANTY SDN BHD</Text>
                            <Text style={{ ...styles.p, fontSize: 7 }}>
                                No. 1A & 3A, Jalan 8/1. Seksyen 8,
                            </Text>
                            <Text style={{ ...styles.p, fontSize: 7 }}>
                        ...
                        <View style={{ ...styles.section, textAlign: 'right', marginBottom: 5 }}>
                            <Text style={{ ...styles.p, fontSize: 7 }}>1 800 88 8287</Text>
                            <Text style={{ ...styles.p, fontSize: 7 }}>+6 03 8922 0571</Text>
                            <Text style={{ ...styles.p, fontSize: 7, marginTop: 0 }}>info@ezcare-warranty.com</Text>
                        </View>
                    </View>
                </View>
            </Page>
