...
const AddNonInspection = ({ closeModal, claim, values }: any) => {
    ...
    const onSubmit = async (e: any) => {
        ...
        if (values) {
            put(route('non-inspection.update', values.id), {
                data,
                onSuccess: () => {
                    reset(),
                        closeModal()
            ...
            post(route('non-inspection.store'), {
                data,
                onSuccess: () => {
                    reset(),
                        closeModal()
...
export default AddNonInspection;