...
import UploadImageForm from "@/Components/DefaultForms/UploadImageForm";
...
function BannerForm({ values, closeModal }: { values?: any, closeModal?: any }) {
    ...
    const onSubmit = (e: any) => {
        ...
        if (!values) {
            post(route('mobile-settings.banners.store'), {
                data,
                onSuccess: () => {
                    reset(),
            ...
            put(route('mobile-settings.banners.update', values.id), {
                data,
                onSuccess: () => {
                    reset(),
                        closeModal && closeModal()
