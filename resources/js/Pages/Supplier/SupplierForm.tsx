...
export default function SupplierForm({ values, closeModal }: { values?: any, closeModal?: any}) {
    ...
    const { data, setData, post, put, reset, errors } = useForm({
        ...
        phone_no: (values && values.phone_no) ? values.phone_no : '',
    });
    ...
    return (
        <>
            <form onSubmit={onSubmit}>
                ...
                <AppInput label='Phone' required id='phone_no' values={data} errors={errors ? errors : null} onChange={(e: any) => setData('phone_no', e.target.value)} />
